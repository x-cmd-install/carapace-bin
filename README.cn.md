...
[![x-cmd/install — carapace-bin Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/carapace-bin.svg?lang=zh)](https://x-cmd.com/install/carapace-bin)

## 安装

```sh
x install carapace-bin
```

## 代码洞察

合计: **444,671** 行代码（覆盖前 5 种语言、共 **19773** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 321,445 | 5,207 | 58,782 | 13149 |
...
- **上游仓库**: <https://github.com/carapace-sh/carapace-bin>
- **官网**: <https://carapace.sh>
- **许可证**: MIT

## 发布

- **最新版本**: `v1.7.3` (2026-06-30)
- **最近提交**: 2026-09-24
- **Release 含资产**: 26 个

## 流行度

- **Star**: 1,966 · **Fork**: 149 · **开放 issue**: 365 · **贡献者**: 77

## 累计统计

- **发布数**: 183 · **已合并 PR**: 3236 · **开放 PR**: 24 · **已关闭 issue**: 296 · **开放 issue**: 69 · **提交数**: 6694

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 44 | 5 | 6 | 1 | 54 |
| last60d | 2026-07-27 | 0 | 121 | 19 | 10 | 5 | 143 |
| 90d | 2026-06-27 | 2 | 181 | 20 | 12 | 7 | 260 |
| last180d | 2026-03-29 | 6 | 341 | 22 | 24 | 12 | 470 |
| 360d | 2025-09-30 | 18 | 642 | 22 | 60 | 21 | 825 |
| last720d | 2024-10-05 | 29 | 965 | 24 | 128 | 39 | 2042 |
...
carapace-bin 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `carapace-bin` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/carapace-bin.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T04:44:40Z._
